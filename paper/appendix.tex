...
\subsection{Full Performance Breakdown}

Table~\ref{tab:detailed_metrics} presents the detailed performance metrics for all 20 stocks in our core dataset, comparing EATA with the NoRL baseline (EATA without Profit Head). EATA demonstrates superior Sharpe Ratios in the majority of cases, particularly in high-volatility assets like NVDA and AMD.
...
\subsection{Search Efficiency Comparison}
...
\textbf{Proposition 1.} Wasserstein distance is superior to MSE and KL divergence for financial returns due to three properties: metric structure, tail sensitivity, and geometric interpretation.
...
\textbf{Expression 3: Volatility-Adjusted Momentum}
\begin{equation}
...
\textbf{Expression 4: Mean Reversion with Volume}
\begin{equation}
