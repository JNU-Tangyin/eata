...
This section introduces the technical details of the Explainable Algorithmic Trading Agent (EATA). We first establish a unified notation system, see Appendix ~\ref{app:notation} for details, and then describe the core algorithm and its design principle.
