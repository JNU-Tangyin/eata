...
Table~\ref{tab:main_results} reports performance metrics averaged across our evaluation universe. EATA achieves competitive risk-adjusted returns with a \textbf{Sharpe Ratio of 0.54}, demonstrating comparable performance to traditional baselines (MACD, Sharpe 0.56) while maintaining full interpretability through symbolic expressions.
...
\midrule
MACD & 11.4 & 0.56 & 34.7 & 52\% & 0.33 \\
Buy \& Hold & 12.6 & 0.51 & 50.3 & 58\% & 0.25 \\
PPO (FinRL) & 7.8 & 0.40 & 27.8 & 45\% & 0.28 \\
LightGBM & 10.3 & 0.33 & 44.1 & 54\% & 0.23 \\
ARIMA & 5.7 & 0.30 & 45.0 & 35\% & 0.13 \\
GP (Operon) & 1.0 & 0.13 & 36.6 & 51\% & 0.03 \\
Transformer & 2.0 & 0.09 & 15.9 & 48\% & 0.13 \\
LSTM & -4.9 & -0.08 & 31.6 & 42\% & -0.15 \\
\midrule
\textbf{EATA (Ours)} & \textbf{17.6}$^{**}$ & \textbf{0.54}$^{**}$ & \textbf{34.0} & \textbf{52.3\%} & \textbf{0.52} \\
\bottomrule
\end{tabular}%
}
\end{table}
